    ...
    if (pgpWasFound) {
        if (whitelist->getIsFullVersion()) {
            ...
            label->setText("<p>Hi "
                          ...
                          "<p>Unfortunately, the times and dates were mixed up, making them invalid for the experiment."
                          "This tool is going to count those same messages again, to complete the experiment."
